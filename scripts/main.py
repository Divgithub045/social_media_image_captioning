...
print(f"✅ InceptionV3 model loaded on {device}")
...
print("✅ Caption generation system ready!")
print("📞 Use generate_caption(image_path, method='greedy'/'beam_search', K_beams=3)")